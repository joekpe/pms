		                                ...
		                                <tr class="<?php if( ($counter % 2) == 0 ){ echo "even"; }else{ echo "odd"; } ?> pointer">
		                                    ...
		                                    <td class=" ">
		                                    	<div class="btn-group" role="group" aria-label="...">
												  <a href="stall_synopsis.php?id=<?php echo $row['id']; ?>&&page=<?php echo basename($_SERVER['PHP_SELF'])."&&year=".@$_GET['year']."&&student_id=".$row['student_id']."&&topic=".$row['topic']; ?>" class="btn btn-default btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Stall"><i class="fa fa-pause"></i></a>
												  <a href="reject_synopsis.php?id=<?php echo $row['id']; ?>&&page=<?php echo basename($_SERVER['PHP_SELF'])."?year=".@$_GET['year']; ?>" class="btn btn-default btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Reject"><i class="fa fa-thumbs-down"></i></a>
												</div>
		                                    </td>
		                                </tr>
...
function updateYear(val){
 ...
 location.assign('approved_synopsis.php?year='+val);
}
