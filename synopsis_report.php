<?php
	...
	if(@$_GET['year'] == '0'){
		$s = $database->query_db("SELECT * FROM synopsis ");
	}
	else{
		$s = Synopsis::find_all_for_year(@$_GET['year']);
	}
?>
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="dashboard_graph">
			...
			<div class="row x_title">
				<div class="col-md-6">
					<h3><small>Synopsis List</small></h3>
				</div>
				<div class="col-md-6">
                        ...
                        <div class="x_content" id="printableArea">
                            ...
                            <table class="table table-striped responsive-utilities jambo_table bulk_action">
	                            ...
	                            <tbody>
	                            	<?php
	                            		$counter = 1;
										while($data = $database->fetch_array($s)){
	                                ...
	                                <tr class="<?php if( ($counter % 2) == 0 ){ echo "even"; }else{ echo "odd"; } ?> pointer">
	                                    ...
	                                    <td class=" "><?php echo $data['topic']; ?></td>
	                                    <td class=" "><?php render_status($data['status']); ?></td>
	                                </tr>
...
function updateYear(val){
 ...
 location.assign('synopsis_report.php?year='+val);
}
